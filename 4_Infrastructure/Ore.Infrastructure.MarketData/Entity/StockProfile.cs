...
namespace Ore.Infrastructure.MarketData
{
    ...
    {
        public static IEnumerable<StockProfile> ToDataObject(this IEnumerable<IStockProfile> self)
        {
            return self.Select(p => p.ToDataObject());
        }

        public static StockProfile ToDataObject(this IStockProfile self)
        {
            StockProfile outputData = new StockProfile
            {
