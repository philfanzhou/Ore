...
namespace Ore.Infrastructure.Common
{
    public class JsonHelper
    {
        ...
        /// <returns>反序列化后的值</returns>
        public static T JsonToModel<T>(string jsonString, Encoding encoding)
        {
        ...
        /// <param name="encoding">编码格式</param>
        /// <returns>反序列化后的值</returns>
        public static List<T> JsonToList<T>(string jsonString, Encoding encoding)
        {
            return JsonToModel<List<T>>(jsonString, encoding);
        }
    }
}
